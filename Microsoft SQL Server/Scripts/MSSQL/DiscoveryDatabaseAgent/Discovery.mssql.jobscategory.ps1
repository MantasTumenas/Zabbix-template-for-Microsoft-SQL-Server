# Query count of database maintenance jobs which jobs are in Database Maintenance category.
    ...
    try
    {
        ...
        if ($connection -ne $null)
        {
            ...
            $SqlCmd = New-Object System.Data.SqlClient.SqlCommand
            	# Select the current instance name and Query count of database maintenance jobs which jobs are in Database Maintenance category. 
